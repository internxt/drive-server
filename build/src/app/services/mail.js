...
module.exports = function (Model) {
    ...
    var sendEmailTeamsMember = function (name, member, cryptedToken, teamName) {
        var mailer = mailInstance();
        return new Promise(function (resolve, reject) {
            mailer.dispatchSendGrid(member, 'join-team', {
                template: 'join-team',
                go: { in: 'here' },
                memberName: name,
                teamName: teamName,
