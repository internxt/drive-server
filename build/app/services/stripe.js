...
module.exports = function () {
    ...
    var getAllStorageProducts2 = function (isTest) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var stripe, cacheName, cachedPlans, response, stripeProducts, products, _loop_1, _i, stripeProducts_1, stripeProduct;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        stripe = getStripe(isTest);
                        cacheName = "stripe_plans_v3_" + (isTest ? 'test' : 'production');
                        cachedPlans = cache.get(cacheName);
                        if (cachedPlans) {
                            return [2 /*return*/, cachedPlans];
                        }
                        return [4 /*yield*/, stripe.products.list({ limit: 100 })];
                    case 1:
                        response = _a.sent();
                        stripeProducts = response.data
                            ...
                            .sort(function (a, b) { return a.metadata.size_bytes * 1 - b.metadata.size_bytes * 1; });
                        products = [];
                        _loop_1 = function (stripeProduct) {
                            var prices;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        prices = _b.sent();
                                        products.push.apply(products, prices.map(function (price) { return (__assign(__assign({}, stripeProduct), { price: __assign(__assign({}, price), { amount: price.amount * 0.01, monthlyAmount: (price.recurring
                        ...
                        _i = 0, stripeProducts_1 = stripeProducts;
                        _a.label = 2;
                    case 2:
                        if (!(_i < stripeProducts_1.length)) return [3 /*break*/, 5];
                        stripeProduct = stripeProducts_1[_i];
                        return [5 /*yield**/, _loop_1(stripeProduct)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
     ...
     */
    var findCustomersByEmail = function (email, isTest) {
        if (isTest === void 0) { isTest = false; }
        return __awaiter(void 0, void 0, void 0, function () {
            var stripe, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        stripe = getStripe(isTest);
                        return [4 /*yield*/, stripe.customers.list({ email: email })];
                    case 1:
                        result = _a.sent();
    ...
    var getUserSubscriptionPlans = function (email) { return __awaiter(void 0, void 0, void 0, function () {
        var isTest, stripe, customers, plans;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    stripe = _a.sent();
                    return [4 /*yield*/, findCustomersByEmail(email, isTest)];
                case 2:
                    customers = _a.sent();
                    plans = [];
                    if (!customers) return [3 /*break*/, 4];
                    // ! To fix duplicated stripe customers
                    return [4 /*yield*/, async.eachSeries(customers, function (customer) { return __awaiter(void 0, void 0, void 0, function () {
                            var allCustomerSubscriptions;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, stripe.subscriptions.list({ customer: customer.id, status: 'all', expand: ['data.plan.product'] })];
                                    case 1:
                                        allCustomerSubscriptions = _a.sent();
                                        allCustomerSubscriptions.data
                                            .sort(function (a, b) { return b.created - a.created; });
                                        plans.push.apply(plans, allCustomerSubscriptions.data.map(function (subscription) { return ({
