...
module.exports = function (Model, App) {
    ...
    var GetDetails = function (user) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, Model.AppSumo.findOne({ where: { userId: user.id } }).then(function (license) { return __awaiter(void 0, void 0, void 0, function () {
                    var unlimited;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, Model.plan.findOne({ where: { userId: user.id, name: 'appsumo_unlimited_members' } })];
                            case 1:
                                unlimited = _a.sent();
                                if (unlimited) {
