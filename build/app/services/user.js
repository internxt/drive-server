...
module.exports = function (Model, App) {
    ...
    var UpdateUserStorage = function (email, maxSpaceBytes) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var CreateStaggingUser = function (email) { return __awaiter(void 0, void 0, void 0, function () {
        var randomPassword, encryptedPassword, encryptedHash, encryptedSalt, newMnemonic, encryptedMnemonic, userObject, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    randomPassword = CryptServiceInstance.RandomPassword(email);
                    ...
                    return [4 /*yield*/, FindOrCreate(userObject)];
                case 1:
                    user = _a.sent();
    ...
    return {
        ...
        CreateStaggingUser: CreateStaggingUser,
        getUsage: getUsage,
