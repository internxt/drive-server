...
module.exports = function (Model, App) {
    ...
    var findById = function (id) { return Model.users.findOne({ where: { id: id } }); };
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, App.services.UsersReferrals.createUserReferrals(userData.id)];
                case 5:
                    // Creates user referrals
                    _c.sent();
                    user = {
                ...
                case 8:
                    e_1 = _c.sent();
                    return [3 /*break*/, 9];
                case 9: return [2 /*return*/, { token: token, user: user, uuid: userData.uuid }];
            }
        });
    }); };
