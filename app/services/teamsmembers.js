...
module.exports = (Model, App) => {
     ...
     */
    const removeMembers = (member) => new Promise((resolve, reject) => {
     ...
     */
    const getInvitationsByIdTeam = (idTeam) => new Promise((resolve, reject) => {
     ...
     */
    const getMemberByIdTeam = (idTeam, email) => new Promise((resolve, reject) => Model.teams_members.findOne({
        where: {
            id_team: { [Op.eq]: idTeam },
            user: { [Op.eq]: email }
        }
     ...
     */
    const addTeamMember = (idTeam, userEmail, bridge_password, bridge_mnemonic) => new Promise((resolve, reject) => {
        Model.teams_members.findOne({
            where: {
                id_team: { [Op.eq]: idTeam },
